...
urlpatterns = [
    ...
    path("byType/", views.ProductListByProductType.as_view(), name="list-by-type"),
    ...
    path("update/", views.UpdateProduct.as_view(), name="update-product"),
    path("detail/", views.ProductDetail.as_view(), name="detail-product"),
